...
const Gallery = () => {
  return (
    <div className="grid grid-cols-3 gap-4 ">
      <div className="h-96 w-96 rounded-lg relative overflow-hidden transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110  duration-300">
        <img
          className="object-cover h-full w-full rounded-lg border-dashed border-4 transition-transform ease-in-out duration-300 group-hover:scale-95 border-indigo-600"
